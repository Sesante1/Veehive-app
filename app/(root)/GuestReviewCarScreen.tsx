...
const GuestReviewCarScreen = () => {
  const { bookingId, carId, guestName, guestImage, hostId, carMake, carModel } =
      ...
      <ScrollView className="flex-1 px-4">
        ...
        <View className="mt-6 p-4 bg-gray-50 rounded-lg">
          <Text className="font-JakartaSemiBold text-lg">
            <Image source={{ uri: guestImage }} className="h-20 w-20" />
          </Text>
        ...
        <View className="mt-8">
          ...
          <TextInput
            ...
            placeholder="Tell us about your trip... (minimum 10 characters)"
...
export default GuestReviewCarScreen;
