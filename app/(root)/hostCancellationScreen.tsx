  ...
  const handleCancelBooking = async () => {
    ...
    try {
      ...
      if (isConfirmed && bookingData.paymentStatus === "paid") {
        ...
        Alert.alert(
          "Booking Cancelled",
          `₱${totalAmount.toLocaleString("en-PH", { minimumFractionDigits: 2 })} has been refunded to the guest.`,
      ...
      <ScrollView className="flex-1 px-4">
        ...
        <View className="mt-8 bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <Text className="font-JakartaMedium text-red-800 text-sm leading-5">
            As a host, cancelling confirmed bookings may affect your performance
            rating and reliability score. Please only cancel when absolutely
            necessary.
          </Text>
        </View>
        ...
        <View className="mt-8">
          ...
          <View className="flex-row justify-between py-4">
            ...
            <Text className="font-JakartaBold text-lg text-red-600">₱0.00</Text>
          </View>
        </View>
        ...
        <View className="mt-4 bg-gray-50 rounded-lg p-4">
          <Text className="font-JakartaMedium text-secondary-700 text-sm leading-5">
            The guest will receive a full refund within 5-10 business days. You
            will not receive any earnings from this booking.
          </Text>
        </View>
