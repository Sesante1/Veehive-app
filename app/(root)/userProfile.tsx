    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-1 p-4">
        ...
        <View className="border-b border-gray-200 mb-6 pb-6 flex-row items-center justify-between">
          ...
          <Pressable
            className="p-2"
            onPress={() => router.push({pathname: "/identityVerification", params: { documents: JSON.stringify(userData?.identityVerification), userId: user?.uid}})}
          >
            <Text className="text-lg font-JakartaBold underline">Start</Text>
          </Pressable>
        </View>
      </View>
    </SafeAreaView>
